...
export function Sell({
  ...
  return (
    <div className="rounded-xl border bg-zinc-950 p-4 text-red-400">
      ...
      {sellingUI ? (
        ...
        <>
          <div className="relative mt-6 pb-6">
            ...
            <input
              ...
              min="10"
              max="1000"
              className="h-1 w-full cursor-pointer appearance-none rounded-lg bg-zinc-600 accent-red-500 dark:bg-zinc-700"
            />
          ...
          <button
            className="mt-6 w-full rounded-lg bg-red-400 px-4 py-2 font-bold text-zinc-900 hover:bg-red-500"
            onClick={async () => {
              const response = await confirmSell(symbol, price, value)
        ...
        <p className="mb-2 text-white">
          You have successfully sold {value} ${symbol}. Total value:{' '}
